...
static const char *monologue = "If you want to survive you have to fight\n";
static const char *monologue2 = "Find the crystal to be able to attack\n";
...
{
    if (pos.x >= 1170 && pos.x <= 1350 && pos.y <= 2017 && pos.y >= 1817)
        return true;
    return false;
}
