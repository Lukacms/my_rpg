...
static const char *monologue = "You are on the good road\n";
static const char *monologue2 = "An item that you need is here, find it !";
...
{
    if (pos.x >= 10171 && pos.x <= 10371 && pos.y <= 4301 && pos.y >= 4101)
        return true;
    return false;
}
